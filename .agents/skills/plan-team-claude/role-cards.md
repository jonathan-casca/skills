...
- Add Iris for a large codebase, an existing subsystem being extended, refactoring, or any proposal for a new shared primitive. Default to selecting Iris unless the task is an isolated one-file change.
