...
Run one single-model team with the selected roles and one adversarial round. Do not create candidate-plan comparison or a synthesis team. Spawn a new decision owner after the discussion to create `final-plan.md`.
